<?php include_once 'views/banner/header.php' ?>
<!-- End Header -->
<div id="content">
		<div class="main">
			<div class="container">
				<div class="box-breadcrumbs">
					<div class="breadcrumbs">
						<ul>
							...
							<li class="product">
								<strong>Plaid Cotton Shirt-Khaki-M</strong>
							</li>
						</ul>
					</div>
				</div>
											...
											<div class="img-left">
												<div class="product-image product-image-zoom">
													<div class="product-image-gallery">
														<img width="380" height="570" title="Plaid Cotton Shirt-Khaki-M" alt="Plaid Cotton Shirt-Khaki-M" src="views/banner/images/photo/11.png" class="gallery-image visible" id="image-main">
													</div>
												</div>
												<!--product-image-zoom-->	
												<div class="popup-btn  hidden-phone">
													<a href="#" data-fancybox-group="button" class="fancybox-buttons" id="popup-image">
													Click to popup views/banner/images		</a>
													...
													<div class="jCarouselLite">
														<ul class="product-image-thumbs">
															<li >
																...
																<img alt="" src="views/banner/images/photo/11.png">
																</a>
															</li>
															<li >
																<a data-image-index="1" title="pink" href="#" class="thumb-link">
																<img alt="pink" src="views/banner/images/photo/12.png">
																</a>
															</li>
															<li >
																<a data-image-index="2" title="indigo" href="#" class="thumb-link">
																<img alt="indigo" src="views/banner/images/photo/13.png">
																</a>
															</li>
															<li >
																<a data-image-index="3" title="orange" href="#" class="thumb-link">
																<img alt="orange" src="views/banner/images/photo/14.png">
																</a>
															</li>
															<li >
																<a data-image-index="4" title="" href="#" class="thumb-link">
																<img alt="" src="views/banner/images/photo/15.png">
																</a>
															</li>
															<li >
																<a data-image-index="0" title="" href="#" class="thumb-link">
																<img alt="" src="views/banner/images/photo/16.png">
																</a>
															</li>
															<li >
																<a data-image-index="1" title="pink" href="#" class="thumb-link">
																<img alt="pink" src="views/banner/images/photo/17.png">
																</a>
															</li>
															<li >
																<a data-image-index="2" title="indigo" href="#" class="thumb-link">
																<img alt="indigo" src="views/banner/images/photo/18.png">
																</a>
															</li>
															<li >
																<a data-image-index="3" title="orange" href="#" class="thumb-link">
																<img alt="orange" src="views/banner/images/photo/19.png">
																</a>
															</li>
															<li >
																<a data-image-index="4" title="" href="#" class="thumb-link">
																<img alt="" src="views/banner/images/photo/20.png">
																</a>
															</li>
															<li >
																<a data-image-index="0" title="" href="#" class="thumb-link">
																<img alt="" src="views/banner/images/photo/1.png">
																</a>
															</li>
															<li >
																<a data-image-index="1" title="pink" href="#" class="thumb-link">
																<img alt="pink" src="views/banner/images/photo/2.png">
																</a>
															</li>
															<li >
																<a data-image-index="2" title="indigo" href="#" class="thumb-link">
																<img alt="indigo" src="views/banner/images/photo/11.png">
																</a>
															</li>
															<li >
																<a data-image-index="3" title="orange" href="#" class="thumb-link">
																<img alt="orange" src="views/banner/images/photo/11.png">
																</a>
															</li>
															<li>
																<a data-image-index="4" title="" href="#" class="thumb-link">
									...
									<div class="product-shop col-lg-5 col-md-5 col-sm-12 col-xs-12">
										<div class="box-left">
											<div class="product-name">
												<h1>Plaid Cotton Shirt-Khaki-M</h1>
											</div>
											<div class="rating">
												<div class="ratings">
											...
											<div class="product-code box-style">
												<ul>
													...
													<li class="last">msj006c-Khaki-M</li>
												</ul>
											</div>
											...
											<div class="short-description">
												<div class="std">
													Lorem Ipsum has been the industry's standard dummy text ever since the 1500s been the industry's standard dummy text ever since been the industry's standard dummy text ever since . Lorem Ipsum has been the industry's standard dummy text ever since the 1500s been the industry's standard dummy text ever since been the industry's standard dummy text ever since 						
												</div>
											</div>
									...
									<div class="inner">
										...
										<div class="tab-content">
												...
												<div class="inner-tab">
													<div id="decription" style="display:block">
														<div class="tab-banner col-lg-12 col-md-12 col-sm-12 col-xs-12">
															<a href="#"><img src="views/banner/images/banner/ca-b45.png" alt=""></a>
														</div>
														<h2>Details</h2>
														<div class="std">
															...
															<div class="des-right col-lg-8 col-md-8 col-sm-8 col-xs-12">
																...
																<ul class="item-views/banner/images">
																	<li><img src="views/banner/images/banner/ca-b42.png" alt=""></li>
																	<li><img src="views/banner/images/banner/ca-b43.png" alt=""></li>
																	<li><img src="views/banner/images/banner/ca-b44.png" alt=""></li>
																</ul>
															</div>
														</div>
													</div>
											...
											<div id="tab8" class="tab-pane">
												<div id="additional">
													<div class="tab-banner col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<a href="#"><img src="views/banner/images/banner/ca-b46.png" alt=""></a>
													</div>
											...
											<div id="tab9" class="tab-pane">
												<div id="review">
													<div class="tab-banner col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<a href="#"><img src="views/banner/images/banner/ca-b47.png" alt=""></a>
													</div>
													<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											...
											<div id="tab10" class="tab-pane">
												<div id="tags" class="tab-pane">
													<div class="tab-banner col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<a href="#"><img src="views/banner/images/banner/ca-b48.png" alt=""></a>
													</div>
													<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											...
											<div class="inner">
												<div class="item-image">
													<div class="item-image-inner">
														...
														<img alt="Elizabeth Knit Top-Pink-M" src="views/banner/images/photo/11.png"> 
														</a>                              
														<div class="item-btn">
															<div class="btn-wqc">
											...
											<div class="inner">
												<div class="item-image">
													<div class="item-image-inner">
														...
														<img alt="Plaid Cotton Shirt-Royal Blue-M" src="views/banner/images/photo/11.png"> 
														</a>                              
														<div class="item-btn">
															<div class="btn-wqc">
																<a class="link-wishlist" href="#" title="Add to wishlist"></a>
											...
											<div class="inner">
												<div class="item-image">
													<div class="item-image-inner">
														...
														<img alt="Elizabeth Knit Top-Pink-L" src="views/banner/images/photo/11.png"> 
														</a>                              
														<div class="item-btn">
															<div class="btn-wqc">
																<a class="link-wishlist" href="#" title="Add to wishlist"></a>
	...
	<!-- End Content -->
    <?php include_once 'views/banner/footer.php' ?>