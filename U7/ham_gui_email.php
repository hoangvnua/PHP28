...
function send_email($email_recive,$name,$contents,$subject){
  ...
  // Khai báo thư viên phpmailer
      ...
      $mail->Username   = "adnvh1710@gmail.com"; // Tên đăng nhập tài khoản Gmail
      $mail->Password   = "hihi@NVH"; //Mật khẩu của gmail
      $mail->SetFrom("adnvh1710@gmail.com", "Nguyễn Văn Hoàng"); // Thông tin người gửi
      $mail->AddReplyTo("adnvh1710@gmail.com","Nguyễn Văn Hoàng");// Ấn định email sẽ nhận khi người dùng reply lại.
...
send_email("nvhoang.vnua@gmail.com","Nguyễn Văn Hoàng",$contents,$subject)
 ?>
