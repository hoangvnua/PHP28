...
<div class="container">
  ...
  <table class="table table-bordered">
    ...
    <tbody>
      <?php foreach ($product_in_cart as $key => $product) { ?>
        <tr>
          <td><?= $product['product_code'] ?></td>
          <td><?= $product['product_name'] ?></td>
          <td> <a href="plus_product.php?id=<?= $product['product_code'] ?>" class="btn btn-primary">+</a><?= $product['product_amount'] ?><a href="minus_product.php?id=<?= $key ?>" class="btn btn-warning">--</a></td>
